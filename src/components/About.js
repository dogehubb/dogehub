        ...
        <footer className={about.main_container}>
            ...
            <div className={about.textContainer}>
                <section className={about.textSection}>
                    <p>dogehub webapp is based on the meme became popular in 2013. The meme typically consists of a picture of a Shiba Inu dog accompanied by multicolored text in Comic Sans font in the foreground. The text, representing a kind of internal monologue, is deliberately written in a form of broken English. #dogetothemoon</p>
                    <Link className={about.contact_btn} to='/about'>Contact Me</Link>
                </section>
            </div>
            ...
            <footer className={about.copyright}>
                <small className={about.copyright}>&copy; Copyright 2021, All Rights Reserved.</small>
            </footer>
        </footer>
    );
};